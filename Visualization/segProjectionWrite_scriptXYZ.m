...
for kk=1:clusterCount
  ...
  for mm = 1:3
    ...
    bigImxyz((xTile-1)*(compx+1)+1
    xTile*(compx+1)-zz-1, (yTile-1)*(compy+1)+yy+1:yTile*(compy+1)-1, mm) = xzImage;
    bigImxyz((xTile-1)*(compx+1)+xx+1:xTile*(compx+1)-1, (yTile-1)*(compy+1)+1:yTile*(compy+1)-zz-1, mm) = zyImage;
  end
end
cd /home/quan/Desktop/brainbowSegmentation/bb/results/
imwrite(im2uint8(bigImxyz), 'thisBigImXYZ2.jpg');
cd /home/quan/Desktop/brainbowSegmentation/bb/results/
